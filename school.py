...
def getParentPaid(args):
    ...
    #grade = { 'H':'HighSchool'  ,'E':'ElementarySchool' ,'M':'MiddleSchool'}
    ...
    for g in grade:
        ...
        if args.browser == 'c':
            ...
            driver = webdriver.PhantomJS("..\\webdriver\\phantomjs-2.1.1-windows\\bin\\phantomjs")
        elif args.browser == 'i':
            driver = webdriver.Ie("..\\webdriver\\IEDriverServer_win32_2.45.0")
        else:
            driver = webdriver.Chrome("..\\webdriver\\chromedriver")
        ...
        for schoolName in schoolDf['학교명'].head(12):
            debugStr = '웹 호출'
